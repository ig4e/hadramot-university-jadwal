export const subjectCreateSuccessNotification = (subjectName: string) => ({
	...
	description: "تم أضافة المادة <subjectName> بنجاح.".replaceAll(
		"<subjectName>",
		subjectName,
	),
	success: true,
...
export const subjectCreateFailNotification = (subjectName: string) => ({
	...
	description: "تعذر أضافة المادة <subjectName>.".replaceAll(
		"<subjectName>",
		subjectName,
	),
	success: false,
...
export const subjectEditSuccessNotification = (subjectName: string) => ({
	...
	description: "تم تعديل المادة <subjectName> بنجاح.".replaceAll(
		"<subjectName>",
		subjectName,
	),
	success: true,
...
export const subjectEditFailNotification = (subjectName: string) => ({
	...
	description: "تعذر تعديل المادة <subjectName>.".replaceAll(
		"<subjectName>",
		subjectName,
	),
	success: false,
